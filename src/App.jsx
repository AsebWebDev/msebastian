...
function App() {
  ...
  if (localStorageLanguage === undefined || localStorageLanguage !== lang)
    localStorage.setItem("languageCode", lang);

  const toggleLanguage = () => {
    setLang(lang === languages.de ? languages.en : languages.de);
  };
          ...
          <Sidebar.Pushable as={Segment}>
            ...
            >
              ...
              <Menu.Item as="a" href="/publications">
                <Icon name="book" />
                {t(lang, "PUBLICATIONS", "PUBLICATIONS_TITLE")}
              </Menu.Item>
              ...
              {isMobile && (
                <Menu.Item as="a" href="mailto:kontakt@marcelsebastian.de">
